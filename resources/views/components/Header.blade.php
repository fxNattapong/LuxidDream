...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="z-10 relative min-h-screen">
            ...
            <!-- START HEADER -->
            <div class="z-[100] top-0 left-0 flex w-full max-lg:flex-col">
                <!-- START IMAGES -->
                ...
                <!-- START LIST MENU -->
                <ul class="z-[100] ml-auto mr-[5em] flex w-fit mt-[4em] gap-8 max-sm:gap-4 text-xl text-white font-medium whitespace-nowrap max-lg:mt-0 max-lg:mx-auto">
                    <li class="flex items-center justify-center"><a href="#!">How to play</a></li>
                    <li class="flex items-center justify-center"><a href="#!">Home</a></li>
                    <li class="flex items-center justify-center"><a href="#!">About</a></li>
